...
### [**Gómez Palacio**]{style="color:#990000"}
...
::: wrapper
::: {.box .a}
```{r hotspots_dengue_gomes}
# Step 1. extract the locality ####
loc <- rgeomex::extract_locality(cve_edo = "10", 
                                 locality = c("Gomez Palacio", "Lerdo"))
...
::: {.box .b}
```{r forest_plot_gomez, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_gomez,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
...
::: {.box .d}
```{r gauge_blocks_gomez,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
...
::: {.box .e}
```{r gauge_AGEB_gomez, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_gomez, out.height='90%', out.width = '90%', fig.align = "center"}
...
```{r vector_hotspots_gomez, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_10_durango,
                           locality = "Gomez Palacio",
                           cve_edo = "10",
...
### [**Ciudad Lerdo**]{style="color:#990000"}

```{r vector_hotspots_lerdo, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_10_durango,
                           locality = "Lerdo",
                           cve_edo = "10",
                           palette = rcartocolor::carto_pal,
...
```{r vector_hotspots_victoria, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_10_durango,
...
denhotspots::risk_ageb(betas = denmex::eggs_betas_10_durango,
